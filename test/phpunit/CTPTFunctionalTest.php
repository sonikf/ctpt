...
/**
 * \file    test/phpunit/CTPTFunctionalTest.php
 * \ingroup ctpt
 ...
 * @package Testctpt
 */
class CTPTFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/ctpt/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('ctpt/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/ctpt/admin/about.php');
		$this->authenticate();
		return $this->assertContains('ctpt/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('ctptwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCTPT_CTPTTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCTPT_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
